...
╚══════╝ ╚═════╝ ╚═╝  ╚═╝ ╚═════╝  ╚════
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Md Suruj Ahmed
\033[1;37m Facebook:            Md Suruj Ahmed
\033[1;37m Github  :            suruj556677
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back suruj Menu ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://call.whatsapp.com/video/gGpz0R5K23WwL6n2YZKIYY')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/suruj.suruj.528?mibextid=ZbWKwL/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+suruj+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + suruj )
    print("New File Saved:" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back suruj Menu ")
    suruj(allkey)       
